...
<div className="form-row-total">
<div className="form-row">
<input type="text" name="batch" id="batch" className="input-text" placeholder="Organization's Name" required></input>
</div>
<div className="form-row">
<input type="text" name="course" id="course" className="input-text" placeholder="Your Designation" required></input>
</div>
</div>
